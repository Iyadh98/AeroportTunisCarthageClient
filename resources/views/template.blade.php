...
<!-- Mirrored from kiswa.net/themes/star-travel/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Apr 2019 18:51:02 GMT -->
<head>
    <title>Index</title>
    <meta charset="utf-8">
    ...
    <!-- Google Fonts -->
    <link href="{{URL::asset('https://fonts.googleapis.com/css?family=Lato:300,300i,400,400i,700,700i,900,900i%7CMerriweather:300,300i,400,400i,700,700i,900,900i')}}" rel="stylesheet">
    ...
    <!-- Color Panel -->
    <link rel="stylesheet" href="{{URL::asset('css/jquery.colorpanel.css')}}">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <div id="info">
                    <ul class="list-unstyled list-inline">
                        <li><span><i class="fa fa-map-marker"></i></span>1080 Tunis Cedex، Tunis</li>
                        <li><span><i class="fa fa-phone"></i></span>+216 92 455 453</li>
                    </ul>
                </div><!-- end info -->
            </div><!-- end columns -->
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <div id="links">
                    <ul class="list-unstyled list-inline">
                        <li><a href="{{url('/login')}}"><span><i class="fa fa-lock"></i></span>Connexion</a></li>
                        <li><a href="{{url('/register')}}"><span><i class="fa fa-plus"></i></span>Créer un compte</a></li>
                        <li>
                            <form>
                ...
                <button class="" id="signout" style="display: none;" onclick="signoutt()">Deconnexion</button>
            </div><!-- end columns -->
        </div><!-- end row -->
    </div><!-- end container -->
</div><!-- end top-bar -->
...
<nav class="navbar navbar-default main-navbar navbar-custom navbar-white" id="mynavbar-1">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="{{url('/')}}" class="navbar-brand"><span><i class="fa fa-plane"></i>Aeroport </span>Tunis-Carthage</a>
        </div><!-- end navbar-header -->

        <div class="collapse navbar-collapse" id="myNavbar1">
            <ul class="nav navbar-nav navbar-right navbar-search-link">
                <li class="dropdown"><a href="{{url('/')}}" class="dropdown-toggle">Accueil<span><i class="fa fa-angle-down"></i></span></a>

                </li>
                <li class="dropdown"><a href="{{url('/flights')}}" class="dropdown-toggle">Vols<span><i class="fa fa-angle-down"></i></span></a>

                </li>
                <li class="dropdown"><a href="{{url('/hotels')}}" class="dropdown-toggle" >Hôtels<span><i class="fa fa-angle-down"></i></span></a>
                </li>
                <li class="dropdown"><a href="{{url('/boutiques')}}" class="dropdown-toggle" >Boutiques<span><i class="fa fa-angle-down"></i></span></a>
                </li>


                <li class="dropdown"><a href="{{url('/taxis')}}" class="dropdown-toggle">Taxis<span><i class="fa fa-angle-down"></i></span></a>
                ...
                <li class="dropdown"><a href="{{url('/contact')}}" class="dropdown-toggle" >Contact<span><i class="fa fa-angle-down"></i></span></a>
                </li>
    ...
    <div id="mySidenav" class="sidenav" >
        ...
        <div id="main-menu">
            ...
            <div class="list-group panel">
                ...
                <a href="#home-links" class="list-group-item active" data-toggle="collapse" data-parent="#main-menu"><span><i class="fa fa-home link-icon"></i></span>Accueil<span><i class="fa fa-chevron-down arrow"></i></span></a>
                ...
                <a href="{{url('/flights')}}" class="list-group-item" data-toggle="collapse" data-parent="#main-menu"><span><i class="fa fa-plane link-icon"></i></span>Vols<span><i class="fa fa-chevron-down arrow"></i></span></a>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 footer-widget ftr-contact">
                    ...
                    <ul class="list-unstyled">
                        <li><span><i class="fa fa-map-marker"></i></span>1080 Tunis Cedex، Tunis</li>
                        <li><span><i class="fa fa-phone"></i></span>+216 92 455 453</li>
                        <li><span><i class="fa fa-envelope"></i></span>info@aeroporttuniscarthage.com</li>
                    </ul>
                </div><!-- end columns -->
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <div class="popup-ad-text">
                            <h4>Bénéficiez de</h4>
                            <h2><span>20%</span>de promotion</h2>
                            <h4>sur tous les vols</h4>
                            <p>en créant votre compte</p>
                            <a href="#" class="btn btn-orange">Passez à l'action!</a>
...
<!-- Page Scripts Starts -->
<script src="{{URL::asset('js/firebaseauth.js')}}"></script>
<script src=" {{URL::asset('js/jquery.min.js')}}"></script>
<script src="{{URL::asset('js/jquery.colorpanel.js')}}"></script>
<script src="{{URL::asset('js/jquery.magnific-popup.min.js')}}"></script>
<script src="{{URL::asset('js/bootstrap.min.js')}}"></script>
<script src="{{URL::asset('js/jquery.flexslider.js')}}"></script>
<script src="{{URL::asset('js/bootstrap-datepicker.js')}}"></script>
<script src="{{URL::asset('js/owl.carousel.min.js')}}"></script>
<script src="{{URL::asset('js/custom-navigation.js')}}"></script>
<script src="{{URL::asset('js/custom-flex.js')}}"></script>
<script src="{{URL::asset('js/custom-owl.js')}}"></script>
<script src="{{URL::asset('js/custom-date-picker.js')}}"></script>
<script src="{{URL::asset('js/custom-video.js')}}"></script>
<script src="{{URL::asset('js/popup-ad.js')}}"></script>
<script src="{{URL::asset('js/custom-slick.js')}}"></script>
<script src="{{URL::asset('js/slick.min.js')}}"></script>
<!-- Page Scripts Ends -->

</body>

<!-- Mirrored from kiswa.net/themes/star-travel/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Apr 2019 18:54:36 GMT -->
</html>